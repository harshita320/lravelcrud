...
<div id="sidebar-menu">
    ...
    <ul class="metismenu list-unstyled" id="side-menu">
        ...
        <li>
            ...
            <ul class="sub-menu" aria-expanded="false">
                <li><a href="{{ route('admin.pending.review') }}" extended-lightbox.html" data-key="t-lightbox">pending review</a></li>
                <li><a href="{{ route('admin.approve.review') }}" data-key="t-range-slider">approved review </a></li>
        ...
        <li>
            ...
            <ul class="sub-menu" aria-expanded="false">
                <li><a href="{{ route('all.permission') }}" extended-lightbox.html" data-key="t-lightbox">all permission</a></li>
                <li><a href="{{ route('admin.approve.review') }}" data-key="t-range-slider">approved permission </a></li>
